...
title: "Biller notes"
nav_order: 6
permalink: /biller-notes/
description: "Paynow BillPay biller quirks: Test Biller prefixes, ZETDC multiple tokens, Pink Lotto bet encoding, EVD stock errors, airtime and Liquid Home service logins."
date: 2026-09-21
last_modified_at: 2026-09-21
seo:
  type: WebPage
image:
  path: /assets/og/biller-notes.png
  width: 1200
  height: 630
  alt: "Biller notes - Paynow BillPay Skill"
source_file: paynow-paybill-skills/paynow-billpay/references/biller-notes.md
---
...
This page is generated from [`paynow-paybill-skills/paynow-billpay/references/biller-notes.md`](https://github.com/67even/paynow-billpay-skill/blob/main/paynow-paybill-skills/paynow-billpay/references/biller-notes.md) in the skill. Spotted something wrong? [Open an issue](https://github.com/67even/paynow-billpay-skill/issues).
