...
nav_order: 4
permalink: /vendor-workflows/
description: "Build a Paynow BillPay vendor integration: catalogue sync, AUTH then PAY, status polling at 120/180/600 seconds, receipts, refunds and reconciliation."
date: 2026-09-21
last_modified_at: 2026-09-21
seo:
  type: WebPage
image:
  path: /assets/og/vendor-workflows.png
  width: 1200
  height: 630
  alt: "Vendor integration - Paynow BillPay Skill"
source_file: paynow-paybill-skills/paynow-billpay/references/vendor-workflows.md
lede: "The end-to-end flow for agents and apps that vend tokens, airtime and bill payments from a prefunded BillPay wallet."
---

# Vendor integration

A step-by-step guide to building a production Vendor API integration. Field and enum details are in [`api-reference.md`](../api-reference/). Biller quirks are in [`biller-notes.md`](../biller-notes/).
...
This page is generated from [`paynow-paybill-skills/paynow-billpay/references/vendor-workflows.md`](https://github.com/67even/paynow-billpay-skill/blob/main/paynow-paybill-skills/paynow-billpay/references/vendor-workflows.md) in the skill. Spotted something wrong? [Open an issue](https://github.com/67even/paynow-billpay-skill/issues).
