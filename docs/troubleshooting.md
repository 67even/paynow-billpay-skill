...
description: "Symptom-to-cause table for Paynow BillPay: failed UAT tests, 401 and 400 errors, double charges, missing ZESA tokens and webhook signature mismatches."
date: 2026-09-21
...
image:
  ...
  width: 1200
  height: 630
  alt: "Troubleshooting - Paynow BillPay Skill"
source_file: paynow-paybill-skills/paynow-billpay/references/troubleshooting.md
lede: "Start here when something is broken. Most BillPay problems are one of a few dozen things, and the symptom usually points straight at the cause."
---

# Troubleshooting

Symptom → cause → fix. Most BillPay problems are one of the entries below. Field details are in [`api-reference.md`](../api-reference/), flows in [`vendor-workflows.md`](../vendor-workflows/), and biller quirks in [`biller-notes.md`](../biller-notes/).
...
UAT is a joint screen-share with Paynow, covering seven tests. See [`go-live-checklist.md`](../go-live/).
...
This page is generated from [`paynow-paybill-skills/paynow-billpay/references/troubleshooting.md`](https://github.com/67even/paynow-billpay-skill/blob/main/paynow-paybill-skills/paynow-billpay/references/troubleshooting.md) in the skill. Spotted something wrong? [Open an issue](https://github.com/67even/paynow-billpay-skill/issues).
